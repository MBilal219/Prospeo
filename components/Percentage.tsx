  ...
  return (
    <>
      ...
      <p className="font-coresans text-center text-sm  font-normal lg:text-lg 1.5xl:text-xl 2xl:text-2xl 1.5xl:max-w-[60%] lg:max-w-[80%] 2xl:max-w-[85%]">
        “The depth and breadth of Prospeo’s database has enabled us to prospect
        better accounts and bring in larger deals. In fact, since bringing on
        Prospeo the average company size we’re closing has grown by 2.5x.”
      </p>
